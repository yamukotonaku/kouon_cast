...
【意外性】説話には、聞き手が「なるほど」「意外だ」と感じるようなひねりや視点の転換を織り交ぜてください。参考コンテキストに載っている説話と似た展開・結末にならないよう、予想外の登場人物（泥棒、子ども、動物、名もなき老人、異なる職業の者など）、逆説的な結末、身近な比喩や意外な対比を選び、印象に残る意外性を出してください。古典の枠を守りつつ、既存説話とかぶらない意外性のある展開を心がけてください。
